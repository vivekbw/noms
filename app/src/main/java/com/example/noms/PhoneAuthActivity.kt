...
class PhoneAuthActivity : ComponentActivity() {
    ...
    // Removed unused variables related to Firebase authentication
    /*
    ...
    Column(
        ...
        if (!isCodeSent) {
            ...
            Button(
                onClick = {
                    ...
                    */
                    ...
                    // Directly navigate to MainActivity without authentication
                    context.startActivity(Intent(context, MainActivity::class.java))
                    // Optional: Finish the current activity to prevent returning back
            ...
            Button(
                onClick = {
                    /*
                    // Commented out Firebase verification call
                    verifyCode(verificationCode, storedVerificationId, auth, context)
                    */

                    // Directly navigate to MainActivity without verification
                    context.startActivity(Intent(context, MainActivity::class.java))
                    // Optional: Finish the current activity to prevent returning back
                    (context as? ComponentActivity)?.finish()
                },
...
// Commented out Firebase-related functions as they are no longer needed
/*
